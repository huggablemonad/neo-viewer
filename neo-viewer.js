...
var _huggablemonad$neo_viewer$Neo$decodeMissDistance = function () {
	var lunar = A2(
	...
	return A2(
		...
		'close_approach_data',
		A2(_elm_lang$core$Json_Decode$tuple1, _elm_lang$core$Basics$identity, lunar));
}();
var _huggablemonad$neo_viewer$Neo$Neo = F7(
	function (a, b, c, d, e, f, g) {
		return {id: a, name: b, url: c, minDiameter: d, maxDiameter: e, pha: f, missDistance: g};
	});
var _huggablemonad$neo_viewer$Neo$decodeNeo = A2(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$custom,
	_huggablemonad$neo_viewer$Neo$decodeMissDistance,
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'is_potentially_hazardous_asteroid',
		_elm_lang$core$Json_Decode$bool,
		function () {
			var hi = _elm_lang$core$Native_List.fromArray(
				['estimated_diameter', 'meters', 'estimated_diameter_max']);
			return A2(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$requiredAt, hi, _elm_lang$core$Json_Decode$float);
		}()(
			function () {
				var lo = _elm_lang$core$Native_List.fromArray(
					['estimated_diameter', 'meters', 'estimated_diameter_min']);
				return A2(_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$requiredAt, lo, _elm_lang$core$Json_Decode$float);
			}()(
				A3(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
					'nasa_jpl_url',
					...
					A3(
						...
						A3(
							...
							'neo_reference_id',
							_elm_lang$core$Json_Decode$string,
							_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_huggablemonad$neo_viewer$Neo$Neo))))))));
var _huggablemonad$neo_viewer$Neo$decodeNeos = function (numElements) {
	return (_elm_lang$core$Native_Utils.cmp(numElements, 0) > 0) ? A2(
		_elm_lang$core$Json_Decode_ops[':='],
		'near_earth_objects',
		_elm_lang$core$Json_Decode$keyValuePairs(
			_elm_lang$core$Json_Decode$list(_huggablemonad$neo_viewer$Neo$decodeNeo))) : _elm_lang$core$Json_Decode$fail('No data found.');
};
var _huggablemonad$neo_viewer$Neo$getToday = function () {
	var decoder = A2(
		_elm_lang$core$Json_Decode$andThen,
		A2(_elm_lang$core$Json_Decode_ops[':='], 'element_count', _elm_lang$core$Json_Decode$int),
		_huggablemonad$neo_viewer$Neo$decodeNeos);
	var url = 'https://api.nasa.gov/neo/rest/v1/feed/today?api_key=DEMO_KEY';
	return A2(_evancz$elm_http$Http$get, decoder, url);
}();

var _huggablemonad$neo_viewer$Viewer$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _huggablemonad$neo_viewer$Viewer$neoItem = function (neo) {
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'bg-success',
						_1: _elm_lang$core$Basics$not(neo.pha)
					},
						{ctor: '_Tuple2', _0: 'bg-danger', _1: neo.pha},
						{ctor: '_Tuple2', _0: 'neo-item', _1: true}
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('h3')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(neo.name),
								A2(
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$href(neo.url)
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html$text(neo.id)
									]))
							]))
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('h4')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Estimated diameter (in meters): '),
						function (_p0) {
						...
						_elm_lang$core$Native_List.fromArray(
							[])),
						_elm_lang$html$Html$text('Miss distance (in lunars): '),
						function (_p2) {
						return _elm_lang$html$Html$text(
							_elm_lang$core$Basics$toString(
						...
						_elm_lang$core$Native_List.fromArray(
							[])),
						_elm_lang$html$Html$text('Potentially hazardous: '),
						_elm_lang$html$Html$text(
						neo.pha ? 'Yes' : 'No')
					]))
			]));
};
var _huggablemonad$neo_viewer$Viewer$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Near Earth Object Viewer')
					])),
				A2(
				_elm_lang$html$Html$p,
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'date', _1: true},
								{ctor: '_Tuple2', _0: 'lead', _1: true}
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[]),
				A2(_elm_lang$core$List$map, _huggablemonad$neo_viewer$Viewer$neoItem, model.neos))
			]));
};
var _huggablemonad$neo_viewer$Viewer$Model = F2(
	function (a, b) {
		return {date: a, neos: b};
	});
var _huggablemonad$neo_viewer$Viewer$update = F2(
	function (msg, model) {
		var _p3 = msg;
		if (_p3.ctor === 'FetchSucceed') {
			var data = A2(
				...
				_elm_lang$core$List$head(_p3._0));
			return {
				ctor: '_Tuple2',
				_0: A2(
					_huggablemonad$neo_viewer$Viewer$Model,
					_elm_lang$core$Basics$fst(data),
					_elm_lang$core$Basics$snd(data)),
...
var _huggablemonad$neo_viewer$Viewer$FetchFail = function (a) {
	return {ctor: 'FetchFail', _0: a};
};
var _huggablemonad$neo_viewer$Viewer$FetchSucceed = function (a) {
	return {ctor: 'FetchSucceed', _0: a};
};
var _huggablemonad$neo_viewer$Viewer$getNeosToday = A3(_elm_lang$core$Task$perform, _huggablemonad$neo_viewer$Viewer$FetchFail, _huggablemonad$neo_viewer$Viewer$FetchSucceed, _huggablemonad$neo_viewer$Neo$getToday);
var _huggablemonad$neo_viewer$Viewer$init = {
	ctor: '_Tuple2',
	_0: A2(
		_huggablemonad$neo_viewer$Viewer$Model,
		'Loading...',
		_elm_lang$core$Native_List.fromArray(
			[])),
	_1: _huggablemonad$neo_viewer$Viewer$getNeosToday
};

var _huggablemonad$neo_viewer$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _huggablemonad$neo_viewer$Viewer$init, view: _huggablemonad$neo_viewer$Viewer$view, update: _huggablemonad$neo_viewer$Viewer$update, subscriptions: _huggablemonad$neo_viewer$Viewer$subscriptions})
};

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _huggablemonad$neo_viewer$Main$main === 'undefined' ? null : _huggablemonad$neo_viewer$Main$main);
